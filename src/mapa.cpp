...
void dibujarHabitacion(int habitacionActual, Jugador* jugador) {
    ...
    for (int i = 0; i < jugador->vida; i++) {
        int x = 8 + i * 24;
        int y = 8;
        dibujarRect(x,   y+4,  8,  8,  220, 0, 0);
        dibujarRect(x+8, y+4,  8,  8,  220, 0, 0);
        dibujarRect(x+2, y,    12, 8,  220, 0, 0);
        dibujarRect(x,   y+8,  16, 8,  220, 0, 0);
        dibujarRect(x+2, y+14, 12, 4,  220, 0, 0);
        dibujarRect(x+6, y+16, 4,  4,  220, 0, 0);
    }
